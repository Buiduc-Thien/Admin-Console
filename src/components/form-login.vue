                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        ...
                        <div class="title mb-4 text-center">
                            <h4 class="text-black mb-0">Đăng nhập</h4>
                        </div>
                        <form @submit.prevent="logIn" class="register-form">
                            ...
                            <div class="mb-4 input-password">
                                <input type="password"
                                    class="form-control placeholder--color-00073 focus-primary    h-41 fs-7" id="email"
                        ...
                        <div class="redirect-login d-flex align-items-center justify-content-center fs-7">
                            <p class="mb-0 me-2 text-black">Bạn chưa đã có tài khoản?</p>
...
export default {
    ...
    methods: {
        logIn() {
            ...
            apiClient.post(API_URL + 'login', this.formData)
                .then(response => {
